...
const Navbar_comp = () => {
  ...
  return (
    <Navbar
      className="bg-[#00070e1a] text-white font-Inter z-[9999]  position-fixed "
    ...
    >
      <NavbarBrand>
        <a href="https://www.almemater.com/#home" target="_blank" rel="noopener noreferrer">
  ...
  {isConnected && (
    ...
    >
      ...
      <p style={{
        ...
        color: '#fff',
        paddingLeft: '0.5rem',
      }}>{discordData === "" ? "Link Discord" : discordData}</p>
    </div>
  )}
</NavbarItem>
